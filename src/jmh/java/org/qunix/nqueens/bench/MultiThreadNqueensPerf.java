...
public class MultiThreadNqueensPerf {
  ...
  public void leetCodeCountImpl() {
    new Solution2().totalNQueens(14);
  }

  public static void main(String[] args) throws RunnerException {
    Options opt =
        new OptionsBuilder().include("." + MultiThreadNqueensPerf.class.getSimpleName()+ ".*").forks(1).build();
